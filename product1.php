...
<body>
<p style="font-size: 36px; color: #F00; font-weight: bolder; font-style: normal;">รายการอุปกรณ์ของกลุ่มงานบริหารระบบเครือข่ายคอมพิวเตอร์</p>
...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="1"  bgcolor="#3399FF">
  ...
  <?php echo $arr['picture'];?>";
    <td><img src="../images/<?php echo $arr['picture'];?>" width="100"  alt=""/></td>
